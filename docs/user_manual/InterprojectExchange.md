...
Фрагмент кода в новом исполнении из открытого проекта:
...
Фрагмент кода в старом исполнении из открытого проекта:
...
Рассмотрим фрагменты кода, когда мы принимаем сигналы из открытогое проекта в альтернативном (который не открыт в Eplan, но открытый проект взаимодействует с этим проектом, как с альтернативным).
