...
В этом разделе расписано, что надо переделать в старом описании _shared.lua_, что бы его можно было редактировать через этот модуль.
