...
<p align="justify">Для того, чтобы сохранить обмен сигналами, нужно нажать кнопку "<b>Сохранить</b>" в главном окне. Система запустит сохранение и закроет форму. В итоге, будут сгенерированы файлы <i>shared.lua</i> для всех проектов, которые участвовали в обмене сигналами. Файл <i>shared.lua</i> открытого проекта будет перезаписан (<i>он всегда генерируется с нуля</i>), а файлы <i>shared.lua</i> альтернативных проектов будут изменены точечно.</p>
