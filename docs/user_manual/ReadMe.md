...
18. Узел перемешивания
    ...
    * *Перемешивание по оборотам*
        ...
        **Примечание:** для параметра №**1** нужно указывать следующие значения: **1** - *влево*, **2** - *вправо*.

        **Шаги**
        1. Определение положения
        2. Соскальзывание с датчика верхнего положения
        3. Движение до верхнего положения
