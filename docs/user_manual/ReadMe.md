...
2. **Включение устройств с задержкой**. Включаются (устанавливаются в активное основное состояние) устройства с установленой задежки в соответствующей группе (либо сразу, если задержки в группе не установлено). По завершению действия устройства отключаются.
