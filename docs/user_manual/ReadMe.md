...
16. Фильтрация пустых полей (*скрывает пустые поля*).
...
13. Узел давления ПИД
    ...
    **Системные параметры**
    ...
    7. Время выхода на режим регулирования, сек
    8. Ручной режим - (**0** - авто, **1** - ручной)
    9. Заданное ручное значение выходного сигнала, бар
    10. Параметр k2
    11. Параметр Ti
    12. Параметр Td
    13. Максимальное значение выходной величины, бар
    14. Минимальное значение выходной величины, бар
...
15. Узел подогрева ПИД
    ...
    **Системные параметры**
    ...
    7. Время выхода на режим регулирования, сек
    8. Ручной режим - (**0** - авто, **1** - ручной)
    9. Заданное ручное значение выходного сигнала, °C
    10. Параметр k2
    11. Параметр Ti
    12. Параметр Td
    13. Максимальное значение выходной величины, °C
    14. Минимальное значение выходной величины, °C
...
18. Узел перемешивания
    ...
    * *Перемешивание по оборотам*
        ...
        **Параметры**
        ...
        3. Максимальное время работы мешалки - указывается имя параметра
...
19. Узел расхода ПИД
    ...
    **Системные параметры**
    ...
    7. Время выхода на режим регулирования, сек
    8. Ручной режим - (**0** - авто, **1** - ручной)
    9. Заданное ручное значение выходного сигнала, м3/ч
    10. Параметр k2
    11. Параметр Ti
    12. Параметр Td
    13. Максимальное значение выходной величины, м3/ч
    14. Минимальное значение выходной величины, м3/ч
