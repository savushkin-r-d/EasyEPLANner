...
6. Линия
    ...
    * *Наполнение*
        ...
        **Шаги**:
        ...
        4. Проталкивание продукта (дополнительный)
...
12. Танк
    ...
    * *Откачка сыворотки*
        ...
        **Параметры**
        1. Кнопка откачки из верхней части - указывается имя параметра
        2. Кнопка откачки из средней части - указывается имя параметра
        3. Кнопка откачки из нижней части - указывается имя параметра
