...
* ___R___
    ...
    * __P_max__ - Максимальное значение входной величины. Стандартное значение - 100. --TODO
    * __P_min__ - Минимальное значение входной величины. Стандартное значение - 0. --TODO
    ...
    * __P_is_reverse__ - Обратного (_реверсивного_) действия, 0 - false, 1 - true. Стандартное значение - 0 (_false_).
    * __P_is_zero_start__ - Нулевое стартовое значение, 0 - false, 1 - true. Стандартное значение - 1 (_true_).
...
* ___R___
    * __IN_VALUE__ - Устройство, задающее входную величину для ПИД-регулятора.
    * __OUT_VALUE__ - Устройство, задающее выходную величину для ПИД-регулятора (_указывается другой ПИД, если нужен каскадный ПИД_).
