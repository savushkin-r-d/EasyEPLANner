...
Помимо корректного имени, в проекте необходимо задать диапазоны IP-адресов, которые были заложены для этого проекта. Эти диапазоны задаются в свойствах проекта, в полях "_Пользователь, доп. поле[1]_", и "_Пользователь, доп. поле[2]_".

* *Пользователь, доп. поле[1]* - начальные значения диапазонов.
* *Пользователь, доп. поле[2]* - конечные значения диапазонов.

IP-адреса диапозонов задаются через запятую, где каждое значение начала диапозона в __доп.поле 1__ соответсвует значению конца диапозона в __доп.поле 2__. Количество начальных и конечных значений должы совпадать. Пример корректного задания диапозонов адресов: 
- Доп.поле 1: "_10.0.16.230, 10.0.16.250_".
- Доп.поле 2: "_10.0.16.240, 10.0.16.260_".

Следующие записи в допюполях задают диапозоны IP: _10.0.16.230-10.0.16.240_ и _10.0.16.250-10.0.16.260_.
