...
+ [Перечень устройств](#62-Перечень-устройств)
    ...
    + [LIFE_DEVICE. Устройство проверки связи](#6228-life_device-устройство-проверки-связи)
...
#### 6.2.28 LIFE_DEVICE. Устройство проверки связи ####
Обозначение: **LIFE_DEVICE**.
Пример: **+OBJ2-LIFE_DEVICE1**. Объект №2. Устройство проверки связи.
...
| LIFEBIT                     | Устройство проверки связи дискретного сигнала                                                                        |
...
<table>
    ...
    <thbody>
        ...
        <tr> <td> <b> 
        LIFE_DEVICE
            <td> <b> P_DT <td> Время проверки сигнала, <i>мс</i>
    </thbody>
</table>
...
<table>
    ...
    <tr> <td rowspan = 1>
    LIFE_DEVICE
        <td> <b> DEV <td> Проверяемый сигнал. Если тип <b>LIFEBIT</b>,
        то привязываются сигналы <b>DI</b>. Если <b>LIFECOUNTER</b>,
        то - <b>AI</b>.
    </thbody>
</table>
...
26. Устройство - **G**
    ...
    * **G_IOL_8**
        ...
        * VOLTAGE - Напряжение;
        * OUT_POWER_90 - Превышение 90% нагрузки;
27. Устройство - **LIFE_DEVICE**
    * **LIFEBIT** и **LIFECOUNTER**
        * ST - состояние;
        * M - ручной режим;
        * P_DT - время проверки связи с сигналом;
