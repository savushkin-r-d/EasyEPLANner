...
12. Танк
    ...
    * *Заквашивание*
         ...
         **Параметры**:
        1. Номер последующей операции - указывается цифрой
        2. Время заквашивания - указывается имя параметра
...
22. Узел текущего уровня (наполнение)
