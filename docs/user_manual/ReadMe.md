...
1. **Проверить устройства**. Заданные в списке устройства проверяются перед включением операции. В данное поле вносят устройства, которые не участвуют в других действиях, но нужны для корректной работы операции.
...
8. **Устройства**. Служит для упрощения типовой логики работы. Устройства, которые находятся в группе *"устройства"* включаются (активируются), а находящиеся в группе *"реверсные устройства"* включаются в реверс (аналогично действию **Включать реверс**) при активном (хотя бы одном) сигнале из группы *"DI"*. Если нет ни одного сигнала из группы *"DI"*, то устройства в группе *"устройства"* отключаются. Сигналы для группы *"DO"* выдаются всегда. По завершению действия все включенные устройства отключаются. Возможность задавать группами это действие.
9. **Группы DI -> DO**. Специальное действие - дублирование в выходные дискретные сигналы входного дискретного сигнала.
10. **Группы AI -> AO**. Специальное действие - дублирование в выходные аналоговые сигналы входного аналогового сигнала.
...
1. Проверить устройства - все существующие устройства.
2. Включать - **DO**, **M**, **V**;
3. Включать реверс - **M**;
4. Выключать - **DO**, **M**, **V**;
5. Верхние седла - **V** с подтипами **V_MIXPROOF**, **V_AS_MIXPROOF**, **V_IOLINK_MIXPROOF**;
6. Нижние седла - **V** с подтипами **V_MIXPROOF**, **V_AS_MIXPROOF**, **V_IOLINK_MIXPROOF**;
7. Сигналы для включения - **DI**, **GS**;
8. Мойка (DI, DO, устройства)
    * DI - **DI**, **SB**;
    * DO - **DO**;
    * Устройства - **DO**, **M**, **V**;
    * Реверсивные устройства - **M**;
9. Группы DI -> DO - **DI**, **DO**, **SB**;
10. Группы AI -> AO - **AI**, **AO**, **M**.
