...
Это открытый [проект](https://github.com/ostis-dev) базы знаний. Он содержит в себе информацию об объектной модели ISA-88, которая используется при разработке проектов с помощью надстройки EasyEplanner. 
