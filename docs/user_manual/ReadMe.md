...
Название каналов: **DO** - _сигнал для активации_. **DI** - _готовность_, _результат обработки 1_, _результат обработки 2_.  
...
CAM_DO1_DI1 | Камера с сигналом для активации и результатом обработки.
CAM_DO1_DI2 | Камера с сигналом для активации, результатом обработки и готовностью.
CAM_DO1_DI3 | Камера с сигналом для активации, двумя результатами обработки и готовностью.
...
Изделия не проверяются в устройствах следующих типов: __VC__ (*кроме **VC_IOLINK***), __M__ (*кроме **M_ATV***), __DI__, __DO__, __AI__, __AO__, __ПИД-регулятор__, __CAM__.
...
2. Включать реверс - **M**;
3. Выключать - **DO**, **M**, **V**;
4. Верхние седла - **V** с подтипами **V_MIXPROOF**, **V_AS_MIXPROOF**, **V_IOLINK_MIXPROOF**, **V_VIRT**;
5. Нижние седла - **V** с подтипами **V_MIXPROOF**, **V_AS_MIXPROOF**, **V_IOLINK_MIXPROOF**, **V_VIRT**;
...
Перенесено в репозиторий с описанием базовых объектов. Т.е в ptusa-Lua-sys. Файл ReadMe.md.
