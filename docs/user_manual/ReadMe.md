...
+ [Настройка панели инструментов и контекстное меню](#78-настройка-панели-инструментов-и-контекстное-меню)
...
<p align=justify>При привязке агрегата к типовому объекту можно прявязать группу объектов к группе этого типового объекта. Для этого в привязываемых объектах должны быть заданы ОУ и они должны находиться в базовом объекте одного подтипа. Тогда привязка произойдет в соответствии с технологическими номерами объектов.</p>

### 7.8 Настройка панели инструментов и контекстное меню ###
...
<p align="justify">Контекстное меню редактора содержит основные операции с элементами дерева. Также меню предпологает сокрытие недоступных для элемента функций, как показано на рисунке ниже.</p>
