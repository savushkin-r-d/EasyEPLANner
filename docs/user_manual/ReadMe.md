...
В этом разделе описаны все, реализованные на текущий момент времени, базовые объекты, их операции и параметры, которые находятся в этих операциях. Оборудование описано в следующем разделе.
