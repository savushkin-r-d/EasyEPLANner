...
16. **Переход к состоянию по условию**. Анологичено предыдущему действию для перехода в разные состояния. Реализовано для состояний выполнения и ожидания во время выполнения операции.
