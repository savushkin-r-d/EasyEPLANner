...
Функционал поддерживает настройку параметров устройства по его изделию. Для этого, нужно знать имя параметра, которое нужно настроить, и значение, которое нужно указать. Имя параметра можно посмотреть в шаблоне устройства.
