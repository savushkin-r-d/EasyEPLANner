...
<table>
    ...
    <thbody>
        <tr> <td> <b> 
        V 
            <td> <b> P_ON_TIME <td> Время включения, _мс_. (_Для клапанов с обратной связью_)
        <tr> <td rowspan = 3> <b> 
        AI
        ...
        <tr> <td> <b> 
        FS  
            <td> <b> P_DT <td> Время порогового фильтра, мс.
        <tr> <td rowspan = 3> <b> 
        QT
            <td> <b> P_C0    <td> Сдвиг нуля <tr>
            <td> <b> P_MIN_V <td> Минимальное значение <tr>
        ...
        LT_IOLINK
            ...
            <td> <b> P_MAX_P   <td> Давление на которое настроен датчик, <i>бар.</i> <tr>
            <td> <b> P_R       <td> Радиус танка, <i>м.</i> <tr>
            <td> <b> P_H_CONE  <td> Высота конической части танка, <i>м.</i> (изначально - 0) <tr>
            <td> <b> P_ERR     <td> Аварийное значение уровня
        <tr> <td> <i> 
            Примечение 
            <td colspan = 2> Параметр <b>P_H_CONE</b> задается по необходимости. Если он не задан - это обычный <b>LT_IOLINK</b> или <b>P_H_CYL</b> (<i>нет разницы</i>). Задается только один из параметров, задаваемое значение - цифра <i>1</i>. Если значение не задается, то не обязательно писать, что этот параметр равен <i>0</i>, его можно удалить из устройства, он автоматически станет <i>0</i>.
        </tr>
        <tr> <td rowspan = 2> <b> 
        TE
            <td> <b> P_C0  <td> Сдвиг нуля <tr> 
        ...
        WT
            ...
            <td> <b> P_DT  <td> Рабочий коэффициент передачи, <i>мВ/В.
        <tr> <td rowspan = 1> <b> 
        WT_RS232
        ...
        C_PID<br>(ПИД-регулятор)
            <td> <b>                     <td> <p align=right> Описание – Значение по умолчанию <tr>
            ...
            <td> <b> P_acceleration_time <td> Время выхода на режим регулирования – 30 с. <tr> 
        ...
        C_THLD<br>(Пороговый регулятор)
            ...
            <td> <b> P_ON_TIME <td> Задержка включения, мс. <tr>
            <td> <b> P_OFF_TIME <td> Задержка выключения, мс.
        <tr> <td rowspan = 4> <b> 
        CAM
