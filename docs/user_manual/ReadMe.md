...
6. Линия
    ...
    * Счетчик - `FQT1`
    ...
    Можно задавать группы танков для наполнения и выдачи.
...
Объект **номер 23** (*Пользовательский объект*) описывает любой пользовательский объект, и предоставляет этот объект для взаимодействия в коде LUA через файл **main.plua** и другие файлы, которые будут присоединены к **main.plua**. 
