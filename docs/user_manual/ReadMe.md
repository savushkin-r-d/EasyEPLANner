...
+ [Перечень устройств](#62-Перечень-устройств)
    ...
    + [ПИД-регулятор](#6222-C-ПИД-регулятор)
...
Обозначение: Любое обозначение устройства, с содержащимся на втором и более месте символом - **C**.
