...
+ [Описание окна редактора](#61-Описание-окна-редактора)
    ...
    + [Сохранение результатов редактирования](#614-Сохранение-результатов-редактирования)
    + [Использование параметров в объекте](#615-Использование-параметров-в-объекте)
+ [Использование функциональности базового объекта и базовой операции](#62-Использование-функциональности-базового-объекта-и-базовой-операции)
    ...
    + [Оборудование базового объекта](#623-Оборудование-базового-объекта)
    + [Рекомендации по использованию ОУ (обозначений устройств) в объектах](#624-Рекомендации-по-использованию-ОУ-обозначений-устройств-в-объектах)
...
* ___LT_IOLINK___
    * __P_MAX_P__ - Давление, на которое настроен датчик, _бар_.
    * __P_R__ - Радиус танка, _м_.
    * __P_H_TRUNC__ - Высота усеченной части танка, _м_ (изначально - 0).
    * __P_H_CONE__ - Высота конической части танка, _м_. (изначально - 0).

Параметры **P_H_CONE** и **P_H_TRUNC** задаются по необходимости. Если они не заданы - это обычный **LT_IOLINK** или **P_H_CYL** (*нет разницы*). Задается только один из параметров, задаваемое значение - цифра *1*. Если значение не задается, то не обязательно писать, что этот параметр равен *0*, его можно удалить из устройства, он автоматически станет *0*.
...
#### 6.1.5 Использование параметров в объекте ####
...
#### 6.2.3 Оборудование базового объекта ####
...
#### 6.2.4 Рекомендации по использованию ОУ (_обозначений устройств_) в объектах ####
...
##### 8.3.1 Экспорт информации для SCADA из проекта #####
