...
Помимо описанных выше действия, шаги включают в себя параметры времени (__время шага__ и __максимальное время шага__) для безусловного перехода к шагу, указаному в поле __"номер следуюшего шага"__. В полях __"Время (параметр)"__ и __"Максимальное время шага (параметр)"__ указывается номер параметра, а в самом параметре устанавливается значение времени в ***секундах (с)***.
