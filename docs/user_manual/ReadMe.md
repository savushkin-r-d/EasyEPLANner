...
**Поиск**:
 ...
 - Поиск включает в себя 2 настройки: 
    ...
    + Примеры при включении <b><ins>ab</ins></b> и <b>.*</b>:

        * можно искать устройства с логическим выражением: "<b>TANK1V1 || TANK1V2 TANK1V3</b>" - ищет строки, содержащие _TANK1V1_ или _TANK1V2_ и _TANK1V3_. Так же есть возможность поиска номеров устройств в преде;

        * "<b>TANK1V[1-3]</b>" - найдет все устройства в диапозоне: _TANK1V1_ ,_TANK1V2_ и _TANK1V3_;
