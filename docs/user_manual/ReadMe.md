...
**Поиск**:
 ...
 - Поиск включает в себя 2 настройки: 
    ...
    + <b><ins>ab</ins></b> - Слово целиком. Ищет слова только целиком, как указано в поисковой строке, то есть при запросе "<b>TANK1V1</b>" устройства _TANK1V11 TANK1V12_ не будут включены в поиск.
    + <b>.*</b> - Использовать регулярные выражения. При включении этой настройки поиск поддерживает логические выражения, например: "<b>TANK1V1 | TANK1V2 TANK1V3</b>" - ищет строки, содержащие _TANK1V1_ или _TANK1V2_ и _TANK1V3_.
