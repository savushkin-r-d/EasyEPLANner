...
2. Создать типовой объект на основе тех. объекта коммандой Создать(<kbd>Insert</kbd>), типовой объект приобретет все поля исходного объекта;

3. Сгруппировать несколько технологических объектов из контекстного меню, как показано на рисунке ниже, либо использовать комбинацию клавиш <kbd>Ctrl</kbd>+<kbd>G</kbd>. В этом случае типовой объект автоматически приобретет общие поля выделенных объектов:

<p align=center>
    <img src=images/CreateGenericGroupFromManyObjects.png/>
    <br><b>Рисунок</b> - <i>Группировка нескельких технологических объектов и создание типового объекта на их основе</i>
</p>
