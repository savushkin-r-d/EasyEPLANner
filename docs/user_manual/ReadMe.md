...
2. Бачок
    ...
    * *Охлаждение*
        ...
        **Параметры**
        1. Активная работа - булевское, да или нет. Описывает работу танка при отсутствии активных операций. Если нужно, что бы бачок откачивал воду даже при отсутствии активных операций танка, то выбираем - Да;
