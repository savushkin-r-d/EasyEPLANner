...
Устройство подключается к модулю множественной привязкой с подключаемыми к нему устройствами.
эти устройства должны быть определенного подтипа, например: **AO_EY**, **VC_EY**, **VC_IOLINK_EY**.
У этих подтипов появляется рабочий параметр `R_EY_NUMBER`, обозначающий номер канала в преобразователе.
...
28. Устройство - **EY**
    * **DEV_CONV_AO2**
        * ST - состояние;
        * V - Аналоговое значение канала 1;
        * V2 - Аналоговое значение канала 2;
        * ERR - Авария устройства;
