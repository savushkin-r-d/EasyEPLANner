...
12. Танк
    ...
    * *Подогрев основы*
        ...
        **Параметры**
        1. Температура подогрева - указывается имя параметра
        2. Максимальное время операции - указывается имя параметра
        3. Температура нагрева воды бойлера - указывается имя параметра

        **Шаги**
        1. Нагрева
        2. Проверка температура
