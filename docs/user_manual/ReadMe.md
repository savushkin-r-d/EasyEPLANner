...
<p align="justify"><b>Адресное пространство узла:</b> узлы имеют ограниченное адресное пространство для подключения модулей, для WAGO - 64, Phoenix Contact - 63. При добавлении модуля превосходящего адресное пространнство узла, появляется соответсвующая ошибка и модуль не сохраняется в описании.</p>
