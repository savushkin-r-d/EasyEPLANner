...
15. **Перейти в шаг по условию**. Специальное действие - переход к шагу по выполнении условия: включение и выключение заданных устройств. Действия включение и выключение устройств групповые: для устройств в одной группе действует условие **И**, а между группами - условие **ИЛИ**. Номер шага указывается в действии "Шаг", при этом номер шага должен быть больше нуля, в ином случае он сбрасывается.
