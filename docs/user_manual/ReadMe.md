...
+ [Использование функциональности базового объекта и базовой операции](#72-Использование-функциональности-базового-объекта-и-базовой-операции)
    + [Привязка базовых объектов друг к другу](#721-Привязка-базовых-объектов-друг-к-другу)
...
#### 7.2.1 Привязка базовых объектов друг к другу ####
...
Надстройка проверяет, какие свойства заполнены, а какие нет. Для того, чтобы опустить проверку свойства (_например, оно не обрабатывается или сложилось так, что его нет, или какие-то другие условия_), необходимо задать специальное значение. При вводе в эти свойства, система проверяет, не введено ли значение-заглушка (слово "**Нет**"). Проверяется не просто слово "**Нет**", а его наличие в вводимой строке. Если было введено слово "__АбвгднетАбвгд__", то система распознает заглушку "**Нет**" и запишет это значение в поле. При автоматической проверке проекта, эти поля не будут проверяться.
