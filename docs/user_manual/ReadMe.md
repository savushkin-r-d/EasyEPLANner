...
11. **Группы DI DI ... -> DO DO ...**. Специальное действие - выдача дискретных сигналов при наличии хотя бы одного из входных дискретных сигналов (поле `Логика` устанавливает тип логики между входными сигналами).
12. **Группы инвертированный DI DI ... -> DO DO ...**. Специальное действие - выдача дискретных сигналов при пропадании хотя бы одного из входных дискретных сигналов (поле `Логика` устанавливает тип логики между входными сигналами).
