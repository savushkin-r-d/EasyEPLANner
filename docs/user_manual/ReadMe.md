...
+ [Автоматическая генерация описания для IOL-Conf](#14-Автоматическая-генерация-описания-для-IOL-Conf)
    + [Генерация шаблонов устройств и модуле ввода-вывода](#141-Генерация-шаблонов-устройств-и-модуле-ввода-вывода)
...
#### 14.1 Генерация шаблонов устройств и модуле ввода-вывода ####
