...
<b>Примечание:</b> подчеркнутые номера - это глобальные номера объектов. Руками их менять нельзя. Объекты нужно привязывать через графический интерфейс. Ровно как и ограничения.
