...
<p align="justify">В технологическом объекте задаются параметры объекта. Сейчас используются "Параметры float", а остальные три типа параметров находятся в запасе.</p>
