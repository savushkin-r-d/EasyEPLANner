...
**Поиск**:
 ...
 - <p align="justify">Расширеный поиск активируется при вводе <b>@</b> или включения поискового запроса в кавычки <b>"..."</b> или <b>'...'</b>. Расширенный поиск ищет конкретные включения элементов, например, по запросу <b>@TANK1V1</b> элементы с устройствами TANK1V11 TANK1V12 не будут включаться в поиск. Также расширенный поиск поддерживает логические выражения, например, запрос "<b>@ TANK1V1 | TANK1V2 TANK1V3</b>" будет искать строки, содержащие TANK1V1 или TANK1V2 и TANK1V3.</p>
