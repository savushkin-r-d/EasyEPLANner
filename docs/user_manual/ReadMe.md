...
+ [Использование функциональности базового объекта и базовой операции](#72-Использование-функциональности-базового-объекта-и-базовой-операции)
    ...
    + [Список базовых объектов, операций с параметрами](#723-Список-базовых-объектов-операций-и-параметров-в-них)
...
#### 7.2.3 Список базовых объектов, операций и параметров в них ####
...
--|--
Автомат | -
Бачок | 1. Охлаждение (параметров нет)
Бойлер | -
Мастер | -
Линия | 1. Мойка (Мойка завершена - сигнал)
Линия приемки | 1. Мойка (Мойка завершена - сигнал)
Линия выдачи | 1. Мойка (Мойка завершена - сигнал)
Пастеризатор | -
Пост | -
Танк | 1. Мойка (Параметры: Мойка завершена - сигнал, МСА свободна - сигнал) 2. Наполнение(Параметры: Номер операции после наполнения - указывается цифрой) 3. Хранение (параметров нет) 4.Выдача (параметров нет)
Узел нагрева | -
Узел охлаждения | 1. Охлаждение (параметров нет)
Узел охлаждения ПИД | 1. Охлаждение (параметров нет)
Узел перемешивания | -
...
Базовое обозначение устройств (для базовых объектов) и куда они привяжутся:
* Узел перемешивания
    * Мешалка - `M1`
...
3. Устройство - **M**
    ...
    * **M_ATV**
        ...
        * FRQ - частота;
4. Устройство - **LS**, **LS_MIN**, **LS_MAX**, **LS_IOLINK_MAX**, **LS_IOLINK_MIN**, **LS_VIRT**
    * ST - состояние;
    * M - ручной режим;
    * P_DT - дельта;
5. Устройство - **FS**
