...
1. [Технологический стек и проекты](#1-Технологический-стек-и-проекты)
    1. [Aga.Controls](#11-AgaControls)
    2. [EasyEPlanner](#12-EasyEPlanner)
    3. [EasyEplanner.Tests](#13-EasyEplannerTests)
    4. [EplanIdleTimeModule](#14-EplanIdleTimeModule)
    5. [ObjectListView2012](#15-ObjectListView2012)
2. [Файловая структура](#2-Файловая-структура)
    1. [Файловая структура готовой для использования надстройки](#21-Файловая-структура-готовой-для-использования-надстройки)
        1. [Корневой каталог](#211-Корневой-каталог)
        2. [Каталог CMD](#212-каталог-CMD)
        3. [Каталог Lua](#213-каталог-Lua)
        4. [Каталог BaseObjectsDescriptionFiles](#214-Каталог-BaseObjectsDescriptionFiles)
    2. [Описание файла configuration.ini и EPLAN.EplAddin.IdleTimeModule.dll.config](#22-Описание-файла-configurationini-и-EPLANEplAddinIdleTimeModuledllconfig)
        1. [Файл конфигурации EasyEPlanner](#221-Файл-конфигурации-EasyEPlanner)
        2. [Файл конфигурации модуля простоя](#222-Файл-конфигурации-модуля-простоя)
    3. [Файлы проектов Aga.Controls и ObjectListView2012](#23-Файлы-проектов-AgaControls-и-ObjectListView2012)
    4. [Файлы проекта EplanIdleTimeModule](#24-Файлы-проекта-EplanIdleTimeModule)
    5. [Файлы проекта EasyEPlanner](#25-Файлы-проекта-EasyEPlanner)
        1. [Корень проекта](#251-Корень-проекта)
        2. [Каталог Configuration](#252-Каталог-Configuration)
        3. [Каталог Device](#253-Каталог-Device)
        4. [Каталог Editor](#254-Каталог-Editor)
        5. [Каталог EProjectManager](#255-Каталог-EProjectManager)
        6. [Каталог FileSavers](#256-Каталог-FileSavers)
        7. [Каталог InterprojectExchange](#257-Каталог-InterprojectExchange)
        8. [Каталог IO](#258-Каталог-IO)
        9. [Каталог Logs](#259-Каталог-Logs)
        10. [Каталог Main](#2510-Каталог-Main)
        11. [Каталог StaticHelper](#2511-Каталог-StaticHelper)
        12. [Каталог TechObject](#2512-Каталог-TechObject)
    6. [Файлы проекта EasyEplanner.Tests](#26-Файлы-проекта-EasyEplannerTests)
3. [Сборка проекта и подписывание библиотек ключом EPLAN](#3-Сборка-проекта-и-подписывание-библиотек-ключом-EPLAN)
    1. [Сборка через терминал](#31-Сборка-через-терминал)
    2. [Сборка через Visual Studio](#32-Сборка-через-Visual-Studio)
    3. [Сборка для подписи надстройки, и её подписывание](#33-Сборка-для-подписи-надстройки-и-её-подписывание)
    4. [Как отлаживать надстройку](#34-Как-отлаживать-надстройку)
