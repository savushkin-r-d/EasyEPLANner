...
namespace Tests.EplanDevices
{
    public class PTTest
    {
        ...
        {
            Assert.AreEqual(IODevice.UnitFormat.Bars, GetRandomPTDevice().PIDUnitFormat);
        }
        ...
        {
            var exportForPT = new Dictionary<ITag, int>()
            {
                {IODevice.Tag.ST, 1},
                {IODevice.Tag.M, 1},
                {IODevice.Tag.V, 1},
            ...
            var exportForPTIOLink = new Dictionary<ITag, int>()
            {
                {IODevice.Tag.M, 1},
                {IODevice.Tag.V, 1},
                {IODevice.Parameter.P_MIN_V, 1},
            ...
            var exportForDevSpae = new Dictionary<ITag, int>()
            {
                {IODevice.Tag.M, 1},
                {IODevice.Tag.V, 1},
                {IODevice.Parameter.P_ERR, 1},
            ...
            var exportForPTVirt = new Dictionary<ITag, int>()
            {
                {IODevice.Tag.M, 1},
                {IODevice.Tag.V, 1},
                {IODevice.Tag.ST, 1},
