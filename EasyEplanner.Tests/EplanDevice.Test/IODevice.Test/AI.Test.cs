...
namespace Tests.EplanDevices
{
    public class AITest
    {
        ...
        {
            Assert.AreEqual(IODevice.UnitFormat.Percentages, GetRandomAIDevice().PIDUnitFormat);
        }
        ...
        {
            var exportForAI = new Dictionary<ITag, int>()
            {
                {IODevice.Tag.M, 1},
                {IODevice.Tag.ST, 1},
            ...
            var exportForAIVirt = new Dictionary<ITag, int>()
            {
                {IODevice.Tag.M, 1},
                {IODevice.Tag.ST, 1},
                {IODevice.Tag.V, 1},
