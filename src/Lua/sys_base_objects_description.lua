            ...
            baseOperations =
            {
                ...
                MIXING_REVOL = {
                    ...
                    steps =
                    {
                        ...
                        FROM_SENSOR_TO_LEFT = {
                            name = "Соскальзывание с датчика верхнего положения влево",
                        },
                        TO_SENSOR_TO_LEFT = {
                            name = "Движение до верхнего положения влево",
                        },
                        FROM_SENSOR_TO_RIGHT = {
                            name = "Соскальзывание с датчика верхнего положения вправо",
                        },
                        TO_SENSOR_TO_RIGHT = {
                            name = "Движение до верхнего положения вправо",
                        },
                    },
                    params = 
                    {   active =
