...
-- Значения этого поля должны быть от 1. (опционально).
        ...
        tank_level_node = {
            ...
            baseOperations =
            {
                WORKING = {
                    ...
                    steps =
                    {
                        WAITING_LOW_LS = { name = "Ожидание пропадания нижнего уровня" },--1
                        FEEDING_HI_LS = { name = "Пополнение до появления верхнего уровня" },--2
                    },
                    defaultPosition = 1,
                },
            },
