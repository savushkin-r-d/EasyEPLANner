namespace Device
{
    ...
    public enum DeviceSubType
    {
        ...
        //HLA
        HLA_R = 1,      ///< Красная лампа + сирена
        HLA_RY,        ///< Красная лампа + желтая лампа + сирена
        HLA_RG,        ///< Красная лампа + зеленая лампа + сирена
        HLA_RYG,      ///< Красная лампа + желтая лампа + зеленая лампа + сирена
    };
}
