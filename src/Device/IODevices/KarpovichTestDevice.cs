...
namespace EplanDevice
{
    ...
    /// </summary>
    sealed public class KarpovichTestDevice : IODevice
    {
        public KarpovichTestDevice(string name, string eplanName, string description,
        ...
        public override string SetSubType(string subtype)
        {
            ...
            switch (subtype)
            {
                case "KarpovichTestDevice_VIRT":
                    break;

                case "KarpovichTestDevice":
                case "":
                    ...
                    AI.Add(new IOChannel("KarpovichTestDevice", -1, -1, -1, ""));
                    break;

                default:
                    errStr = string.Format("\"{0}\" - неверный тип" +
                        " (пустая строка, KarpovichTestDevice, KarpovichTestDevice_VIRT).\n",
                        Name);
                    break;
            }
                ...
                case DeviceType.AI:
                    switch (dst)
                    {
                        case DeviceSubType.AI:
                            return "KarpovichTestDevice";
                        case DeviceSubType.AI_VIRT:
                            return "KarpovichTestDevice_VIRT";
                    }
                    break;
            }
