...
namespace EasyEPlanner.Properties {
    ...
    public class Resources {
        ...
        ///
        ///-- Базовый объект (уникальноые название таблицы - uniqueEplanName т.е LUA-имя объекта,
        ///-- пишется в любых регистрах):
        ...
        ///-- 4. basicName - англоязычное имя объекта, которое фигурирует в функци [остаток строки не уместился]&quot;;.
        /// </summary>
